        ...
        InterpolationSolverAgent()
          {        
           ...
           plus.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) { plusCommand(); }
                });
           minus.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) { minusCommand(); }
                });
           diff.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) { showDTable(); }
                });  
...
*/         m23.add(fgEnable, BorderLayout.CENTER);  // m23.add(fgButton, BorderLayout.EAST); 
           ...
           m.add(m2, BorderLayout.CENTER);m.add(m1, BorderLayout.WEST);
        ...
        private void createTabs()
          {
           for (int i=0; i<3; i++)
               {
                valueAtX[i] = new JTextField(); valueAtX[i].setEditable(false);
                info[i] = new JTextArea(); info[i].setEditable(false);
               }
           ...
           bA.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) { execute(1); }
                });
           ...
           bD.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) { executeNeville(); }
                });
           ...
           bB.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) { execute(2); }
                });
           ...
           bC.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) { execute(3); }
                });
        ...
        private void showDTable()
          {
           try { new DifferenceViewer(null, getX(), getFx()); }
           catch(Exception e) 
        ...
        private void executeNeville() 
          {
           ...
           try{ is = new InterpolationSolver(x, Fx); }
           catch(Exception e)
              {
               JOptionPane.showMessageDialog(Mathematica.MainTab,"Unknown Error...","Error",JOptionPane.ERROR_MESSAGE);                             
               return;
           ...
           try{ nevilleTable = is.nevilleInterpolation(xs[0], xs[xs.length-1], xValue); }
           catch(InterpolationSolverException e)
              {
               JOptionPane.showMessageDialog(Mathematica.MainTab, e.getMessage()+".\nTry again...","Calculation Error",JOptionPane.ERROR_MESSAGE);
               return;
