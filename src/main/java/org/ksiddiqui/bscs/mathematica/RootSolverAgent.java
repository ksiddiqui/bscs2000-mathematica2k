...
import org.ksiddiqui.bscs.mathematica.maths.*;
        ...
        RootSolverAgent()
          {        
           ...
           funcPasteButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) { funcField.paste(); }
                });       
           ...
           m3.add(tolLabel); m3.add(tolField);
           m3.add(iterationLabel); m3.add(iterationField);
           m3.add(steppingLabel); m3.add(steppingField);
           m3.add(showSeq);
        ...
        private void createTabs()
          {
           for (int i=0; i<6; i++)
               {
                ...
                tf3[i] = new JTextField(); tf3[i].setEditable(false);
               } 
           ...
           mA.add(mA1); mA.add(mA2); mA.add(mA3);
           ...
           mB.add(mB1); mB.add(mB2); mB.add(mB3);
           ...
           mC.add(mC1); mC.add(mC2); mC.add(mC3);
           ...
           mD.add(mD1); mD.add(mD2); mD.add(mD3);
           ...
           mF.add(mF1); mF.add(mF2); mF.add(mF3);
        ...
        private void validateInputs(int i) throws Exception
          {
           ...
           if (i<4)
              {
               if (s1==null || s2==null || s1.length()==0 || s2.length()==0 ) throw new Exception("Initial values are invalid.");
               d = Double.parseDouble(s1); d = Double.parseDouble(s2);
              }
           else      
              {
