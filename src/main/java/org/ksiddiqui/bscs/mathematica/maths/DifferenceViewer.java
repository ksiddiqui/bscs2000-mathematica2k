...
//         JPanel m3 = new JPanel(new BorderLayout());
           ...
           m1.add(DDButton); m1.add(DButton); 
           DDButton.addActionListener(new ActionListener() {
               public void actionPerformed(ActionEvent e) { D_command(0); }
              });
           DButton.addActionListener(new ActionListener() {
               public void actionPerformed(ActionEvent e) { D_command(1); }
              });
