...
public class FunctionGrapher implements Serializable {
    ...
    public void setMainPanel() {
        ...
        scaleXField = new JTextField(String.valueOf(scaleX));
        scaleYField = new JTextField(String.valueOf(scaleY));
        JButton clearButton = new JButton("Clear");
        JButton refreshButton = new JButton("Refresh");
        gridToggle = new JToggleButton("Grids");
        gridToggle.setSelected(true);
        markToggle = new JToggleButton("Marker");
        markToggle.setSelected(false);
        colorButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Color c = JColorChooser.showDialog(frame, "Color Chooser", graphColor);
                if (c != null) {
                    graphColor = c;
                    gridImageG.setColor(c);
                }
                colorLabel.setBackground(graphColor);
                colorLabel.repaint();
            }
        ...
        m11.add(colorButton);
        m11.add(colorLabel);
        m12.add(new JLabel("On x axis- 1 square ="));
        m12.add(scaleXField);
        m12.add(new JLabel("On y axis- 1 square ="));
        m12.add(scaleYField);
        m13.add(gridToggle);
        m13.add(markToggle);
        m13.add(clearButton);
        m13.add(refreshButton);
        m1.add(m11, BorderLayout.WEST);
        m1.add(m12, BorderLayout.EAST);
        m1.add(m13, BorderLayout.CENTER);
        ...
        currX.setEditable(false);
        currX.setAutoscrolls(false);
        currY = new JTextField();
        currY.setEditable(false);
        currY.setAutoscrolls(false);
        ...
        m32.add(new JLabel("starting X"));
        m32.add(startX);
        m32.add(new JLabel("ending X"));
        m32.add(endX);
        m33.add(drawGraph, BorderLayout.CENTER);
        m34.add(new JLabel(" X :"));
        m34.add(currX);
        m34.add(new JLabel(" Y :"));
        m34.add(currY);
        m3.add(m31);
        m3.add(m32);
        m3.add(m33);
