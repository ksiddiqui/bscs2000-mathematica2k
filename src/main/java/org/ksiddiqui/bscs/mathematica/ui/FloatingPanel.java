        ...
        public void setFloatingPanelDirection(String str)
          {
           ...
           if (direction!=null)
              {
               if      (direction.compareTo("top")==0)    { incY = 1; incX = 0; } 
               else if (direction.compareTo("right")==0)  { incX = 1; incY = 0; }              
               else if (direction.compareTo("bottom")==0) { incY = -1; incX = 0; } 
               else if (direction.compareTo("left")==0)   { incX = -1; incY = 0; }
              }     
        ...
        private void doCycle()
          {
           ...
           if (direction!=null)
              {
               if      (direction.compareTo("top")==0)   { stY = -y; } 
               else if (direction.compareTo("right")==0) { stX = -w; }              
               else if (direction.compareTo("bottom")==0){ stY = height; } 
               else if (direction.compareTo("left")==0)  { stX = width; }
              }
