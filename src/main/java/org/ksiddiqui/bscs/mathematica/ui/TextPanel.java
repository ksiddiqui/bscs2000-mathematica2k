...
public class TextPanel extends JPanel 
{
   ...
   *******************************************************************************************/        
        ...
        private void initialize()
          {
           strList = new Vector();  strListSize = 0;           
        ...
        public void delText(String str) throws Exception
          {
           ...
           if (str==null) { strList.removeAllElements(); strListSize=0; }
           else           { delTextFromList(str); }
        ...
        public void delText(String[] str) throws Exception       
          {
           ...
           if (str==null) { strList.removeAllElements(); strListSize=0; }
           else           { for (int i=0; i<str.length; i++) delTextFromList(str[i]); }
